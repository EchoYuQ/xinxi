...
public class AlphaView extends View {
    ...
    public AlphaView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获取所有的自定义属性
        TypedArray a = context.obtainStyledAttributes(attrs, com.lzy.widget.R.styleable.AlphaView);
        BitmapDrawable iconNormal = (BitmapDrawable) a.getDrawable(com.lzy.widget.R.styleable.AlphaView_av_tabIconNormal);
        if (iconNormal != null) {
            mIconNormal = iconNormal.getBitmap();
        }
        BitmapDrawable iconSelected = (BitmapDrawable) a.getDrawable(com.lzy.widget.R.styleable.AlphaView_av_tabIconSelected);
        if (iconSelected != null) {
            mIconSelected = iconSelected.getBitmap();
        }
        mText = a.getString(com.lzy.widget.R.styleable.AlphaView_av_tabText);
        mTextSize = a.getDimensionPixelSize(com.lzy.widget.R.styleable.AlphaView_av_tabTextSize, mTextSize);
        mTextColorNormal = a.getColor(com.lzy.widget.R.styleable.AlphaView_av_textColorNormal, mTextColorNormal);
        mTextColorSelected = a.getColor(com.lzy.widget.R.styleable.AlphaView_av_textColorSelected, mTextColorSelected);
        a.recycle();
